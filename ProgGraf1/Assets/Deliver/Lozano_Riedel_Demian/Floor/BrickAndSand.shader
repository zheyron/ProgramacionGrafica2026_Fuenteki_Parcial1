...
Shader "HeightMap"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 UVScale111 = ( appendResult105 / _Scale );
			float2 uv_Heightmap2 = v.texcoord * _Heightmap2_ST.xy + _Heightmap2_ST.zw;
			float4 lerpResult84 = lerp( ( tex2Dlod( _Heightmap1, float4( UVScale111, 0, 0.0) ) * float4( float3(0,1,0) , 0.0 ) * _HMap1Mult ) , ( tex2Dlod( _Heightmap2, float4( uv_Heightmap2, 0, 0.0) ) * float4( _Direction , 0.0 ) * _HMap2Mult ) , _Lerp);
...
/*ASEBEGIN
Version=18900
2;876;2546;484;1642.768;756.7377;1.899036;True;False
Node;AmplifyShaderEditor.CommentaryNode;112;-1182.086,-816.4671;Inherit;False;1362.45;414.9139;UVs by World Position;5;111;108;109;105;103;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;109;-743.0243,-553.2134;Inherit;False;Property;_Scale;Scale;8;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;61;-1146.074,396.4832;Inherit;True;Property;_Heightmap2;Heightmap2;2;0;Create;True;0;0;0;False;0;False;9789d23040cb1fb45ad60392430c3c15;9789d23040cb1fb45ad60392430c3c15;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;67;-726.2416,153.5348;Inherit;False;Property;_HMap1Mult;HMap1 Mult;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;66;-738.1223,624.152;Inherit;False;Property;_Direction;Direction;1;0;Create;True;0;0;0;False;0;False;0,1,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-732.2623,834.1476;Inherit;False;Property;_HMap2Mult;HMap2 Mult;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-61.8214,115.8141;Inherit;False;Property;_Lerp;Lerp;7;0;Create;True;0;0;0;False;0;False;0.3;1.55;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;80;528.9424,280.7892;Inherit;False;Property;_Float0;Float 0;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;73;421.559,-449.3162;Inherit;True;Property;_Albedo;Albedo;3;0;Create;True;0;0;0;False;0;False;97be2fca38ea3d74697518f3fd6681f3;1d5d9561a88dd694cbd6597eed64e574;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=59288128EE4B2125B4CC3C5BFF7036337D9386F9